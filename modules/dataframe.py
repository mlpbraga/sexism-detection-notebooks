...
class Comments:
    ...
    def _set_vocabularies(self):
        ...
        try:
            ...
            self.undefined_vocabulary, self.undefined_frequency_array,self.undefined_word_list = None, None, None
            self.undefined_bigrams, self.undefined_frequency_array, self.undefined_word_list = None, None, None
            print('> No comments without label')
    ...
    def _set_bigrams_frequencies(self):
        ...
        for word in shared_words:
            ...
            if self.undefined_bigrams and word in self.undefined_bigrams.keys():
    ...
    def _set_word_frequencies(self):
        ...
        for word in shared_words:
            ...
            if word in self.sexist_vocabulary.keys():
                ...
                word_freq['not-sexist-freq'].append(0)
            if self.undefined_vocabulary and word in self.undefined_vocabulary.keys():
                word_freq['undefined-freq'].append(
    ...
    def _set_feature_dataframe(self):
        try:
            ...
            print('> Loading local dataframe')
        except:
            print('> Generating dataframe features')
